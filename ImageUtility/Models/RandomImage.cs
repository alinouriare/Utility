    ...
    public class RandomImage
    {
        ...
        private void GenerateImage()
        {
            ...
            PointF[] points =
          {
            ...
            //hatchBrush = new HatchBrush(HatchStyle.Percent10, Color.Black, Color.FromArgb(60, 146, 231));
            hatchBrush = new HatchBrush(HatchStyle.Percent10, Color.Black, Color.FromArgb(86, 59, 87));
